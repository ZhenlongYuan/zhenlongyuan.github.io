...
<div class='paper-box'><div class='paper-box-image'><div><div class="badge">Preprint</div><img src='images/ImagineAgent.png' alt="sym" width="100%"></div></div>
...
<span style="display: inline-block; padding: 2px 10px; margin: 2px 4px 2px 0; background-color: #fff3e0; color: #e65100; border-radius: 15px; font-size: 12px;">Multi-turn Agentic RL</span>
<span style="display: inline-block; padding: 2px 10px; margin: 2px 4px 2px 0; background-color: #f3e5f5; color: #7b1fa2; border-radius: 15px; font-size: 12px;">Generation Model</span>
...
<div class='paper-box'><div class='paper-box-image'><div><div class="badge">Preprint</div><img src='images/Degradation.png' alt="sym" width="100%"></div></div>
<div class='paper-box-text' markdown="1">
...
# 📖 All Publications
- ``ICLR 2025`` [Video-STAR: Reinforcing Zero-shot Video Understanding with Tools.](https://arxiv.org/abs/2510.08480) **Z Yuan**, X Qu, C Qian, et al.
- ``ICLR 2025`` [AutoDrive-R2: Incentivizing Reasoning and Self-Reflection Capacity for VLA Model in Autonomous Driving.](https://arxiv.org/pdf/2509.01944) **Z Yuan**, J Tang, J Luo, et al.
